module supra_oracle::supra_oracle_storage {
    ...
    #[view]
    public fun get_prices(pairs: vector<u32>): vector<Price> {
    ...
    /// simple determinictic formula to get a price
    fun mock_price (pair: u32) :u128 {
        let price = pair * 10 + 1; // simple deterministic formula
        (price as u128)
    }
